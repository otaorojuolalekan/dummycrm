            ...
            <div className="case-info-grid">
                ...
                <div className="grid-item">
                    ...
                    <input
                        type="text"
                        value={
                            caseDetails.date_created
                                ? new Date(caseDetails.date_created).toLocaleString()
                                : "N/A"
                        }
                        readOnly
                    />
                ...
                {/* Date Modified */}
                <div className="grid-item">
                    <label><strong>Date Modified:</strong></label>
                    <input
                        type="text"
                        value={
                            caseDetails.date_modified
                                ? new Date(caseDetails.date_modified).toLocaleString()
                                : "N/A"
                        }
                        readOnly
                    />
